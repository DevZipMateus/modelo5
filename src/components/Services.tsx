...
const Services = () => {
  ...
  return (
    <section id="services" ref={sectionRef} className="bg-white py-20">
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="mt-6 pt-6 border-t border-tech-lightgray">
                <button 
                  className="w-full bg-tech-lightgray hover:bg-tech-blue hover:text-white text-tech-blue font-semibold py-3 rounded-lg transition-all duration-300"
                  onClick={() => {
