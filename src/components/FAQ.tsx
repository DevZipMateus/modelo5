...
const FAQ = () => {
  ...
  return (
    <section id="faq" ref={sectionRef} className="bg-tech-lightgray py-20">
      <div className="section-container">
        ...
        <div className="max-w-4xl mx-auto space-y-4">
          {faqs.map((faq, index) => (
            <Collapsible 
              key={index}
              className="bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300 opacity-0"
