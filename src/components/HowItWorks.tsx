...
const HowItWorks = () => {
  ...
  return <section id="how-it-works" ref={sectionRef} className="py-20 bg-transparent">
      <div className="section-container">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((step, index) => <div key={index} className="bg-white rounded-xl p-8 text-center shadow-lg hover:shadow-xl transition-all duration-300 opacity-0 group" ref={el => elementsRef.current[2 + index] = el}>
        ...
        <div className="text-center mt-12">
          <div className="bg-white rounded-2xl p-8 shadow-lg max-w-2xl mx-auto opacity-0" ref={el => elementsRef.current[6] = el}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="https://wa.me/5555999887766?text=Olá!%20Gostaria%20de%20agendar%20uma%20avaliação." target="_blank" rel="noopener noreferrer" className="bg-tech-green hover:bg-tech-green/90 text-white px-6 py-3 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105">
